...
.peer-hand.ph-seat-4 { left: 50%; top: 100%; margin-top: 44px; transform: translate(-50%, 0) rotate(180deg); }
.peer-hand.ph-seat-5 { left: 50%; top: 100%; margin-top: 44px; transform: translate(-50%, 0) rotate(180deg); }
